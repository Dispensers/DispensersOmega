...
let punterPuzzleSpec = {
	...
	ringSpec: [1, 2, 3, 4, 5, 6, 7, 8, 9],
	colourSpec: ["green", "black", "orange", "blue", "pink"],
	hintSpec: ["orange", 8],
	solutionDispenseSequence: [2, 2, 1, 2, 2, 1, 2, 1, 1],
	solutionColourSequence: ["blue", "black", "orange", "black", "green", "pink", "green", "orange", "green"]
};
*/
/*
let punterPuzzleSpec = {
	number: "A5",
	solveBy: "14 Feb",
	dispenserSpec: [undefined, "rqp", "pqqpp", "r"],
	ringSpec: [1, 2, 3, 4, 5, 6, 7, 8, 9],
	colourSpec: ["orange", "green", "black"],
	hintSpec: ["orange", 8],
	solutionDispenseSequence: [2, 3, 2, 2, 1, 2, 2, 1, 1],
	solutionColourSequence: ["orange", "black", "orange", "green", "orange", "green", "orange", "green", "black"]
};
*/
/*
let punterPuzzleSpec = {
	...
	solutionColourSequence: ["green", "orange", "black", "orange", "green", "black", "green", "black", "orange"]
};
*/
/*
let punterPuzzleSpec = {
	number: "B3",
	solveBy: "7 Feb",
	dispenserSpec: [undefined, "pqrrqp", "sp", "p"],
	ringSpec: [-1, -4, 7, -2, 5, 8, -3, 6, 9],
	colourSpec: ["black", "green", "orange", "blue"],
	hintSpec: ["blue", 5],
	solutionDispenseSequence: [1, 2, 1, 1, 1, 3, 1, 1, 2],
	solutionColourSequence: ["black", "orange", "green", "black", "orange", "black", "green", "black", "blue"]
};
*/
/*
let punterPuzzleSpec = {
	number: "B5",
	solveBy: "7 Feb",
	dispenserSpec: [undefined, "qr", "pq", "qrpppp"],
	ringSpec: [-1, -4, 7, -2, 5, 8, -3, 6, 9],
	colourSpec: ["blue", "orange", "black"],
	hintSpec: ["blue", 5],
	solutionDispenseSequence: [3, 1, 2, 1, 3, 3, 3, 3, 3],
	solutionColourSequence: ["blue", "orange", "blue", "black", "blue", "black", "orange", "blue", "orange"]
};
*/
/*
let punterPuzzleSpec = {
	number: "F3",
	solveBy: "28 Jan",
	dispenserSpec: [undefined, "ptp", "qrrspq"],
	ringSpec: [8, 6, -4, -2, 9, -1, -3, 5, 7],
	colourSpec: ["blue", "black", "orange", "green", "pink"],
	hintSpec: ["green", 6],
	solutionDispenseSequence: [1, 1, 2, 2, 2, 2, 2, 1, 2],
	solutionColourSequence: ["blue", "orange", "blue", "pink", "black", "blue", "black", "green", "orange"]
};
*/
/*
let punterPuzzleSpec = {
	...
	solutionColourSequence: ["orange", "black", "blue", "green", "black", "orange", "black", "orange", "black"]
};
*/
