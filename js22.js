...
class Demo {
	constructor() {
		const puzzleSpec = {
			...
			dispenserSpec: [undefined, "qpp", "qr", "q", "rpqp"],
			ringSpec: [-3, 7, -2, 6, -1, 5, 9, -4, 8],
			colourSpec: ["blue", "orange", "black"],
			hintSpec: ["orange", 6],
			solutionDispenseSequence: [4, 1, 1, 2, 4, 3, 2, 1, 4],
			solutionColourSequence: ["blue", "orange", "blue", "orange", "blue", "orange", "blue", "black", "orange"]
		};
